...
plt.style.use(f"{os.environ['HOME']}/my_web/Machine-Learning-Andrew-Ng/source/source_files/Supervised_Machine_Learning_Regression_and_Classification/week3/OptionalLabs/deeplearning.mplstyle")
